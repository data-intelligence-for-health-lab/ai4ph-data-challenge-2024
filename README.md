...
## Project objective
This Data Challenge project aims to study the association between urban environments and material and social deprivation status.
...
Example: 
- detect objects from images and correlate them with deprivation using statistical modelling;
- prediction of deprivation from indicators;
...
- a Google account; create 5 Google accounts/collab, ai4ph data challenge team 1-5, upload data.
- a city for analysis;
